...
def KungFu(
    ...
    while round_done is False:
        ...
        #     config.num_rollout_workers_max / 2 * decay_factor,
        #     config.num_rollout_workers_min,
        #     config.num_rollout_workers_serverful,
        # ))
        ...
        if prev_gns is None:
            ...
            if gns > prev_gns:
                action["num_rollout_workers"] = int(action["num_rollout_workers"] * (gns/prev_gns))
